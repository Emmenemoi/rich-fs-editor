package com.example.application.views.navigator;
...
@PermitAll
@Uses(Icon.class)
public class NavigatorView extends Div implements BeforeEnterObserver {
    ...
    public NavigatorView(@Autowired SamplePersonService samplePersonService) {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(NavigatorView.class);
            }
        }
    }
